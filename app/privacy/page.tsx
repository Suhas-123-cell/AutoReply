...
export const metadata: Metadata = {
  ...
  description:
    "How AutoReply handles Instagram account data, webhook payloads, billing data, and customer campaign information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      description="AutoReply helps businesses send Meta-compliant private replies when people comment on connected Instagram posts or reels."
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">
          AutoReply does not ask for Instagram passwords, scrape Instagram, or
      ...
      <section>
        ...
        <p className="mt-3">
          The AutoReply mobile app uses the same account and workspace data
