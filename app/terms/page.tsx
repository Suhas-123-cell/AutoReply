...
export const metadata: Metadata = {
  ...
  description:
    "Terms for using AutoReply's Instagram comment-to-DM campaign software.",
};
...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      description="These terms define acceptable use for AutoReply's hosted Instagram comment-to-DM campaign service."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold text-white">Authorized Use</h2>
        <p className="mt-3">
          You may use AutoReply only with Instagram professional accounts you
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          AutoReply may rate-limit, pause, or disable campaigns that create
